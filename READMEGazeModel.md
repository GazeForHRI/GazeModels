# Gaze4HRI L2CS-Net Model Evaluation

## Overview
This repository is a fork of the original L2CS-Net repository, specifically adapted for testing on the Gaze4HRI benchmark. For core environment setup and general model information, please refer to the original `README.md`.
...
The unique component of this repository is `gaze_model_l2cs.py`. This file implements the `GazeModel` abstract class (defined in `gaze_estimation.py`) specifically for the L2CS-Net architecture.