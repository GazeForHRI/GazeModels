...
The unique component of this repository is `gaze_model_puregaze.py`. This file implements the `GazeModel` abstract class (defined in `gaze_estimation.py`) specifically for the PureGaze architecture. Also, like each branch of the GazeModels repo, there is resource_test.py to measure computational efficiency of the model (which was used to create "TABLE S3: Computational efficiency of the methods" in the Supplementary Material).