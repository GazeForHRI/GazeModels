...
The unique component of this repository is `gaze_model_gazetr.py`. This file implements the `GazeModel` abstract class (defined in `gaze_estimation.py`) specifically for the GazeTR architecture.