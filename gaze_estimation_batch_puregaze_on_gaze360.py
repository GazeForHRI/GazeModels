...
def main():
    from gaze_model_puregaze_on_gaze360 import PureGazeOnGaze360
    ...
    puregaze_checkpoint = "/dl_scratch1/berksezer/FaceAndGaze/checkpoint/Res50_PureGaze_Gaze360.pt"
    MODELS = [
        PureGazeOnGaze360(
            weights_path=puregaze_checkpoint,  # directory containing `checkpoint/`
            device="cuda:0",
            rectification=True
        ),
    ]
