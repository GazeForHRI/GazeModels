...
def main():
	from gaze_model_gazetr_gaze360 import GazeTRGaze360
	...
	gazetr_checkpoint = "/dl_scratch1/berksezer/FaceAndGazeGazeTR/checkpoints/GazeTR-H-Gaze360.pt"
	MODELS = [
		GazeTRGaze360(weights_path=gazetr_checkpoint, device="cuda:0", rectification=True),
		GazeTRGaze360(weights_path=gazetr_checkpoint, device="cuda:0", rectification=False),
	]
