...
################### CHANGE THESE ##########################
# .env dosyasını yükle
load_dotenv(dotenv_path="/dl_scratch1/berksezer/FaceAndGaze/.env")
...
def get_experiment_types(order):
...
def get_main_models_included_in_the_paper():
    return {
        "puregaze_rectification": "PureGaze w/ Rect.",
        "gazetr_rectification": "GazeTR w/ Rect.",
        "l2cs_padding0fixed_isrgb_False_resize_448": "L2CS-Net w/ Crop",
        "mcgaze_clip_size_7": "MCGaze w/ Crop",
        "gaze3d_clip_len_8": "GaT w/ Crop",
    }

def get_model_display_names():
    return {
        "puregaze": "PureGaze w/ Crop",
        "puregaze_rectification": "PureGaze w/ Rect.",
        "gazetr": "GazeTR w/ Crop",
        "gazetr_rectification": "GazeTR w/ Rect.",
        "l2cs_padding0fixed_isrgb_False_resize_448": "L2CS-Net w/ Crop",
        "l2cs_padding0fixed_rectification_isrgb_False_resize_448": "L2CS-Net w/ Rect.",
        "mcgaze_clip_size_7": "MCGaze w/ Crop",
        "mcgaze_clip_size_7_rectification": "MCGaze w/ Rect.",
        "gaze3d_clip_len_8": "GaT w/ Crop",
        "gaze3d_clip_len_8_rectification": "GaT w/ Rect.",
    }
...
def is_experiment_directory_excluded_from_eval(exp_dir: str) -> bool:
    """
    Check if a given experiment directory is in the excluded list for evaluation. Allows filtering out bad data.
    """
    base_dir = get_dataset_base_directory()
    ...
    for subject_dir in ["2025-07-29/Selcan (mistake)", "2025-07-31/Ikram (Mistake)"]:
...
#     base_dir = get_dataset_base_directory()
#     exp_dirs = [
#         "2025-07-29/Selcan (mistake)/head_pose_left/h1",
#         f"{base_dir}/2025-07-29/Selcan (mistake)/head_pose_left/h1",
#         "2025-07-31/Denis/lighting_50/p9",
#         f"{base_dir}/2025-07-31/Denis/lighting_50/p9",
#         "2025-07-30/Zehra/lighting_50/p9",
#         f"{base_dir}/2025-07-30/Zehra/lighting_50/p9",
#             "2025-07-29/Selcan (mistake)/head_pose_middle/h1",
#         f"{base_dir}/2025-07-29/Selcan (mistake)/head_pose_middle/h1",
#     ]

#     for exp_dir in exp_dirs:
#         print(is_experiment_directory_excluded_from_eval(exp_dir))
from re import sub
import numpy as np
import subprocess
import os
