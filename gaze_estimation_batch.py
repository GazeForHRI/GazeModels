...
def main():
    ...
    gazetr_checkpoint = "/home/kovan-beta/USTA/FaceAndGazeGazeTR/checkpoints/GazeTR-H-ETH.pt"
    MODELS = [
        GazeTR(weights_path=gazetr_checkpoint, device="cuda:0", rectification=True),
    ] 
