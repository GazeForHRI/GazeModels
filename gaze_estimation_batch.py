...
def main():
    from gaze_model_gaze3d import Gaze3D
    ...
    # On my experiments model works best with RGB input and HeadCrop method. Try to avoid rectification.

    checkpoint_path = f"/home/kovan/FaceAndGazeGaze3D/checkpoints/gat_gaze360.ckpt"
    batch_size=12 # this is the batch size for clip_len_8. multiply by 4 when clip_len is only 1. higher batch_size causes OOM for clip_len=8
    stride = 1
    resize_hw=(224,224)
